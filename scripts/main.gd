...
@onready var event_dialog: Control = $ManagementLayer/EventDialog
@onready var trading_dialog: Control = $ManagementLayer/TradingDialog
@onready var game_over_panel: Control = $ManagementLayer/GameOverPanel
@onready var game_over_label: Label = $ManagementLayer/GameOverPanel/PanelContainer/MarginContainer/VBoxContainer/GameOverLabel
@onready var restart_button: Button = $ManagementLayer/GameOverPanel/PanelContainer/MarginContainer/VBoxContainer/RestartButton
@onready var team_select_dialog: Control = $ManagementLayer/TeamSelectDialog

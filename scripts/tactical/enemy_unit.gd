...
# Enemy type stats
const ENEMY_DATA = {
	"basic": { "max_hp": 50, "max_ap": 1, "move_range": 4, "sight_range": 10, "shoot_range": 8, "damage": 20, "overwatch_range": 0 },
	"heavy": { "max_hp": 80, "max_ap": 2, "move_range": 3, "sight_range": 9, "shoot_range": 6, "damage": 35, "overwatch_range": 0 },

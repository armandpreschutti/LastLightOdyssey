...
class ObjectiveManager:
	...
	static func get_bonus_rewards(objective: MissionObjective) -> Dictionary:
		...
		## Returns Dictionary with "fuel", "cash", and "hull_repair" keys
		...
		match objective.id:
			...
			"retrieve_logs":
				...
				return {"fuel": 0, "cash": 12, "hull_repair": 0}
			"extract_minerals":
			...
			"clear_passages":
				...
				return {"fuel": 0, "cash": 8, "hull_repair": 0}
			"clear_nests":
			...
			"hack_security":
				...
				return {"fuel": 3, "cash": 0, "hull_repair": 0}
			"repair_core":
			...
			_:
				...
				return {"fuel": 3, "cash": 8, "hull_repair": 0}
